...
const requestCounter = meter.createCounter('request.sent.counter', {
...
app.post('/import', async (req, res) => {
    ...
    const weatherDataPromises = addresses.map(async (address) => {
        ...
        try {
            requestCounter.add(1, { 'host-name': 'weatherapi' });
        ...
        try {
            requestCounter.add(1, { 'host-name': 'temp' });
        ...
        try {
            requestCounter.add(1, { 'host-name': 'storage' });
